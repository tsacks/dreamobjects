...
/*
    This file is part of DreamObjects Backup Connection, a plugin for WordPress.

    DreamObjects Backup Connection is distributed in the hope that it will be useful,
...
class DreamObjects_Backup_Plugin_Base {
